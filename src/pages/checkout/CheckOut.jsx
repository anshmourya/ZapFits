...
import CheckSubTotal from "../../components/checkout/CheckSubTotal";
      ...
      <div className="grid sm:px-10 lg:grid-cols-2 lg:px-20 xl:px-32">
        <div className="px-4 pt-8">
          ...
          <div className="px-2 py-4 mt-8 space-y-3 bg-white border rounded-lg sm:px-6">
            {carItems.map((item) => {
              return <CheckoutCart data={item} key={item.id} />;
            })}
          </div>
        ...
        <div className="px-4 pt-8 mt-10 bg-gray-50 lg:mt-0">
          ...
          <div className="">
            ...
            {/* Total */}
            <CheckSubTotal carItems={carItems} />
          </div>
          <button className="w-full px-6 py-3 mt-4 mb-8 font-medium text-white bg-orange-500 rounded-md">
            Place Order
          </button>
        </div>
      </div>
